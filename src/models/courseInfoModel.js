...
export class CourseInfo {
    constructor(data) {
        this.antireqs = data && data.antireqs ? (typeof data.antireqs === "string" ? data.antireqs.split(",") : data.antireqs) : [];
        this.coreqs = data && data.coreqs ? (typeof data.coreqs === "string" ? data.coreqs.split(",") : data.coreqs) : [];
        this.prereqs = data && data.prereqs ? (typeof data.prereqs === "string" ? data.prereqs.split(",") : data.prereqs) : [];
        ...
        this.offering = data && data.offering ? (typeof data.offering === "string" ? data.offering.split(",") : data.offering) : [];
